...
namespace DownloadSorterLibrary {
    ...
    public static class FileExtensions
    {
        ...
        public static List<List<string>> ExtensionList = new List<List<string>>() { archiveExt, executableExt, pictureExt, videoExt };
        ...
        public static void Check()
        {
            if (CurrentTask.path != null)
            {
                ...
                foreach (var file in currentD.GetFiles())
                {
                    ...
                    file.CheckAndMove(ExtensionFlags.Video, CurrentTask.path);
                }
            }
        }
    }
